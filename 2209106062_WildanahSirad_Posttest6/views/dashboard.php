...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css"
        ...
        <link rel="icon" href="../assets/gambar3.jpeg">
        ...
        <div class="right-content">
            ...
            <section class="dash-main">
                ...
                <div class="leading-btn">
                    <a href = "tambah.php"><button class="add-btn"><i class="fa-solid fa-plus"></i></button></a>
                    <button class="history-btn"><i class="fa-solid fa-clock-rotate-left"></i></button>
                </div><br>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                <?php echo $bk["judul"] ?></td>
                                </center>
                            <td>
                                <center>
                                <?php echo $bk["harga"] ?></td>
                                </center>
                            <td>
                                <center>
                                <?php echo $bk["stok"] ?></td>
                            ...
                            <td>
                                <center>
                                <img src="../assets/<?=$bk['gambar'] ?>" alt="ini gambar" width="200px" >
                                </center>
                            </td>
                            <td class="action">
